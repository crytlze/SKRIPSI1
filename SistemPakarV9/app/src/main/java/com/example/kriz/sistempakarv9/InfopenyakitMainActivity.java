...
public class InfopenyakitMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.example.umaru.sistempakarpenyakitdalam.R.layout.activity_main_infopenyakit);
        Toolbar toolbar = (Toolbar) findViewById(com.example.umaru.sistempakarpenyakitdalam.R.id.toolBar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setHomeButtonEnabled(true);
        recyclerView = (RecyclerView) findViewById(com.example.umaru.sistempakarpenyakitdalam.R.id.my_recycler_view);
        recyclerView.setHasFixedSize(true);
        searchView = (SearchView) findViewById(com.example.umaru.sistempakarpenyakitdalam.R.id.searchView);
